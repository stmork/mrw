...
**	$Author: smork $
**	$Id: SignalStateDrawer.java 954 2010-05-01 09:31:46Z smork $
**
 ...
 * gezeichnet, da sich deren Funktionalitöt nicht voneinander unterscheidet. Es wird dabei auch die
...
abstract public class SignalStateDrawer extends StateDrawer implements Colors, Coordinates
{
	 ...
	 * @return Den Zeichner für das Signal.
	 */
