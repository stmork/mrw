...
**	$Author: smork $
**	$Id: InfoView.java 954 2010-05-01 09:31:46Z smork $
**
...
/**
 * Diese Klasse repr‰sentiert eine View, in der die aktiven Fahrstraﬂen und die ausgew‰hlten Gleisabschnitte
 * angezeigt werden.
 * @author sm
 *
 */
public class InfoView extends RccViewPart implements InfoViewId, SelectionListener, ISelectionChangedListener
{
	...
	private final static Log log = LogFactory.getLog(InfoView.class);
	...
	public void createPartControl(Composite parent)
	{
		...
		remove_all_button.setText("Alle lˆschen");
	...
	/**
	 * Diese Methode gibt die in der InfoView ausgew‰hlte Fahrstraﬂe zur¸ck.
	 ...
	 * @param object Das auszuw‰hlende Objekt. Es kann ein Gleisabschnitt oder eine Fahrstraﬂe sein.
	 * @see Abschnitt
	 * @see Route
	 */
	...
	private void removeSelection(SelectionEvent event)
	{
		...
		{
			setMessage("Alle Fahrstraﬂen werden aufgelˆst...");
			controller.removeAllRoutes();
			setMessage("Alle Fahrstraﬂen wurden aufgelˆst...");
		}
		else
		{
			...
			if (route != null)
			{
				setMessage("Fahrstraﬂe wird aufgelˆst...");
				controller.deactivateAction(route);
				controller.removeRoute(route);
				setMessage("Fahrstraﬂe ist aufgelˆst...");
			}
		}
		update();
	}
