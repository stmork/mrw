...
/**
 * Diese RuntimeException wird geworfen, wenn ein betroffenes Gleisteil nicht zur richtigen Fahrstraße passt.
 * @author smork
 *
 */
public class TrackNotRoutedException extends RoutingRuntimeException {
	...
	{
		super(route, "Gleisteil nicht Bestandteil dieser Fahrstraße! (" + gt.getRoute() + "/" + route + ")");
	}
}
