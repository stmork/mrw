	...
	public void setAnschluss(Anschluss newAnschluss) {
		if (newAnschluss != eInternalContainer() || (eContainerFeatureID() != ModelrailwayPackage.LICHT__ANSCHLUSS && newAnschluss != null)) {
			...
			if (newAnschluss != null)
				msgs = ((InternalEObject)newAnschluss).eInverseAdd(this, ModelrailwayPackage.ANSCHLUSS__LICHTER, Anschluss.class, msgs);
			msgs = basicSetAnschluss(newAnschluss, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelrailwayPackage.LICHT__ANSCHLUSS, newAnschluss, newAnschluss));
	}
