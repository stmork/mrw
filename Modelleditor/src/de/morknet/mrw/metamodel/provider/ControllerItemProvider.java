...
/**
 * This is the item provider adapter for a {@link de.morknet.mrw.metamodel.Controller} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControllerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controller_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controller_id_feature", "_UI_Controller_type"),
				 ModelrailwayPackage.Literals.CONTROLLER__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Controller_type") + " " + controller.getId();
	}
